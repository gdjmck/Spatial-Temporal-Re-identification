...
download_path = "/home/chk/Market-1501/Market-1501-v15.09.15/"
...
if opt.Market:
    save_path = "/home/chk/Market-1501/Market1501_prepare/"
else:
...
def gen_train_all_rename():
    path = os.path.join(save_path, "train_all/")
    folderName = []
    ...
    for fname in folderName:
        ...
        if not os.path.exists("/home/chk/Market-1501/Market1501_rename/train_all/" + fname):
            os.makedirs("/home/chk/Market-1501/Market1501_rename/train_all/" + fname)
        ...
        for imgname in img_names:
            ...
            dstfile = "/home/chk/Market-1501/Market1501_rename/train_all/" + fname + "/" + newname
...
def gen_train_rename():
    ...
    for fname in folderName:
        ...
        if not os.path.exists("/home/chk/Market-1501/Market1501_rename/train/" + fname):
            os.makedirs("/home/chk/Market-1501/Market1501_rename/train/" + fname)
        ...
        for imgname in img_names:
            ...
            # print(newname)
            srcfile = path + fname + "/" + imgname
            dstfile = "/home/chk/Market-1501/Market1501_rename/train/" + fname + "/" + newname
            shutil.copyfile(srcfile, dstfile)
            # break  # 测试一个id
...
def gen_val_rename():
    ...
    for fname in folderName:
        ...
        if not os.path.exists("/home/chk/Market-1501/Market1501_rename/val/" + fname):
            os.makedirs("/home/chk/Market-1501/Market1501_rename/val/" + fname)
        ...
        for imgname in img_names:
            ...
            # print(newname)
            srcfile = path + fname + "/" + imgname
            dstfile = "/home/chk/Market-1501/Market1501_rename/val/" + fname + "/" + newname
            shutil.copyfile(srcfile, dstfile)
            # break  # 测试一个id


def gen_query_rename():
    path = os.path.join(save_path, "query/")
    folderName = []
    for root, dirs, files in os.walk(path):
        folderName = dirs
        break
    ...
    for fname in folderName:
        ...
        if not os.path.exists("/home/chk/Market-1501/Market1501_rename/query/" + fname):
            os.makedirs("/home/chk/Market-1501/Market1501_rename/query/" + fname)
        ...
        for imgname in img_names:
            ...
            # print(newname)
            srcfile = path + fname + "/" + imgname
            dstfile = "/home/chk/Market-1501/Market1501_rename/query/" + fname + "/" + newname
            shutil.copyfile(srcfile, dstfile)
            # break  # 测试一个id


def gen_gallery_rename():
    path = os.path.join(save_path, "gallery/")
    folderName = []
    for root, dirs, files in os.walk(path):
        folderName = dirs
        break
    ...
    for fname in folderName:
        ...
        if not os.path.exists("/home/chk/Market-1501/Market1501_rename/gallery/" + fname):
            os.makedirs("/home/chk/Market-1501/Market1501_rename/gallery/" + fname)
        ...
        for imgname in img_names:
            ...
            # print(newname)
            srcfile = path + fname + "/" + imgname
            dstfile = "/home/chk/Market-1501/Market1501_rename/gallery/" + fname + "/" + newname
            shutil.copyfile(srcfile, dstfile)
            # break  # 测试一个id
...
if opt.Market:
    ...
    gen_query_rename()
    gen_gallery_rename()
    #shutil.rmtree("/home/chk/Market-1501/Market1501_prepare/")
    print("Done!")
